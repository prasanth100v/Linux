...
| **Kernel**                | The core of Linux that manages CPU, memory, hardware, and processes                  |
...
| **Terminal**              | The application where you type Linux commands                                        |
| **Command**               | An instruction given to Linux to perform a task                                      |
...
| **PATH**                  | Variable that tells Linux where to find commands                                     |
